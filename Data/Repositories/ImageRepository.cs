...
public class ImageRepository : IImageRepository
{
    ...
    public async Task<Image?> GetImageByIdAsync(int imageId, CancellationToken ct = default) =>
    ...
    public async Task<IEnumerable<Image>> GetImagesByProjectIdAsync(int projectId, CancellationToken ct = default) =>
        await _context.Images
    ...
    public async Task<bool> ImageExistsAsync(int imageId, CancellationToken ct = default) =>
