...
namespace student_profile.Data.Repositories
{
    public class ChatRepository : IChatRepository
    {
        ...
        public async Task<ChatHistory> InitializeChatSessionAsync(Guid userId, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ChatHistory?> GetChatHistoryAsync(Guid userId, CancellationToken cancellationToken = default) =>
